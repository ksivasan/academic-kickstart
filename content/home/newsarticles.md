...
- After weeks of thinking about how to develop "production level" code, I found this blog post simple and to point. As mentioned, reproduceability and documentation are key (over robust testing). For full details, check out [here](https://thuijskens.github.io/2018/11/13/useful-code-is-production-code/) 
