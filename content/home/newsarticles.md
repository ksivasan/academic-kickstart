...
- I figured out from many job portals that writing production level code is a sought after skill to have. But little I understood what it exactly means. I found this blog post simple and to point. As mentioned, reproduceability and documentation are key (over robust testing) for most part. For full details, check out [here](https://thuijskens.github.io/2018/11/13/useful-code-is-production-code/) 
